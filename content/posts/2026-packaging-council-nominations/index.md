...
**To submit a nomination for yourself or someone else, use the [2026 PPC Election Nomination Form](https://www.python.org/nominations/2026-python-packaging-council/create/) on our website. The form will open on Tuesday, July 29th, 2:00 pm UTC and close on Tuesday, August 12th, 2:00 pm UTC.**
...
You can see your membership record and status on your [PSF Member User Information page](https://psfmember.org/user-information). If you are a voting-eligible member and do not already have a login, please [create an account on psfmember.org](https://psfmember.org/wp-login.php?action=register) first and then email [pc-elections@python.org](mailto:pc-elections@python.org) so we can link your membership to your account.
